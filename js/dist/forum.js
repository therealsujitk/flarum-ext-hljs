  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'headerItems', function (items) {
    items.add('therealsujitk-hljs', m('null', {
      ...
      config: function config() {
        ...
        if (typeof document.querySelectorAll("link[href='//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.7.0/styles/default.min.css']")[0] != 'undefined') document.querySelectorAll("link[href='//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.7.0/styles/default.min.css']")[0].href = '//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.7.0/styles/' + theme + '.min.css';
        hljsDefaults(theme);
      }
    }));
  });
