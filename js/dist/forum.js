  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_Composer__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'controlItems', function (items) {
    items.add('therealsujitk-hljs', m('null', {
      ...
      config: function config() {
        ...
        if (typeof document.querySelectorAll("link[href*='cdnjs.cloudflare.com/ajax/libs/highlight.js/9.7.0/styles/']")[0] != 'undefined') document.querySelectorAll("link[href*='cdnjs.cloudflare.com/ajax/libs/highlight.js/9.7.0/styles/']")[0].href = hljsLink;
        if (typeof document.querySelectorAll("link[href*='cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.18.1/build/styles/']")[0] != 'undefined') document.querySelectorAll("link[href*='cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.18.1/build/styles/']")[0].href = hljsLink;
