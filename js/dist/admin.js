...
var hljsSettingsModal = /*#__PURE__*/function (_SettingsModal) {
  ...
  _proto.form = function form() {
    return [m('div[class = Form-group]', [m('label', app.translator.trans('therealsujitk.admin.hljs.themename')), m('select[style = width: 100%; margin-bottom: 5px;]', {
      ...
      value: 'gradient-dark'
    }, 'Gradient Dark'), m('option', {
      value: 'gradient-light'
    }, 'Gradient Light'), m('option', {
      value: 'grayscale'
    }, 'Grayscale'), m('option', {
      value: 'gruvbox-dark'
    }, 'Gruvbox Dark'), m('option', {
      value: 'gruvbox-light'
    }, 'Gruvbox Light'), m('option', {
      value: 'hopscotch'
    }, 'Hopscotch'), m('option', {
      value: 'hybrid'
    }, 'Hybrid'), m('option', {
    ...
    }, 'Isbl Editor Dark'), m('option', {
      value: 'isbl-editor-light'
    }, 'Isbl Editor Light'), m('option', {
      value: 'kimbie.dark'
    }, 'Kimbie Dark'), m('option', {
      value: 'kimbie.light'
    }, 'Kimbie Light'), m('option', {
      value: 'lightfair'
    }, 'Lightfair'), m('option', {
      value: 'lioshi'
    }, 'Lioshi'), m('option', {
      ...
      value: 'paraiso-dark'
    }, 'Paraiso Dark'), m('option', {
      value: 'paraiso-light'
    }, 'Paraiso Light'), m('option', {
      value: 'pojoaque'
    }, 'Pojoaque'), m('option', {
      value: 'purebasic'
    }, 'Purebasic'), m('option', {
      value: 'qtcreator-dark'
    }, 'Qtcreator Dark'), m('option', {
      value: 'qtcreator-light'
    }, 'Qtcreator Light'), m('option', {
      value: 'railscasts'
    }, 'Railscasts'), m('option', {
      value: 'rainbow'
    }, 'Rainbow'), m('option', {
      ...
      value: 'school-book'
    }, 'School Book'), m('option', {
      value: 'shades-of-purple'
    }, 'Shades Of Purple'), m('option', {
      value: 'solarized-dark'
    }, 'Solarized Dark'), m('option', {
      value: 'solarized-light'
    }, 'Solarized Light'), m('option', {
      value: 'srcery'
    }, 'Srcery'), m('option', {
      value: 'sunburst'
    }, 'Sunburst'), m('option', {
      value: 'tomorrow-night-blue'
    }, 'Tomorrow Night Blue'), m('option', {
      value: 'tomorrow-night-bright'
    }, 'Tomorrow Night Bright'), m('option', {
      value: 'tomorrow-night-eighties'
    }, 'Tomorrow Night Eighties'), m('option', {
      value: 'tomorrow-night'
    }, 'Tomorrow Night'), m('option', {
      value: 'tomorrow'
    }, 'Tomorrow'), m('option', {
      value: 'vs'
    }, 'Vs'), m('option', {
      ...
      value: 'zenburn'
    }, 'Zenburn')]), m('hr'), m('div', [m('p[style = display: inline;]', app.translator.trans('therealsujitk.admin.about.stringA')), m('a', {
